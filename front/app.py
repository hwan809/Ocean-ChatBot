...
<<<<<<< HEAD
    답을 안다면 주어진 정보를 사용해 최대한 자세하게 답변하고, 답변 뒤에는 답을 도출하는 데 직접적으로 사용되는 문서의 팀 코드 목록을 문자 '|'로 구분해 안내합니다.
...
=======
    답을 안다면 주어진 정보를 모두 사용해 최대한 자세하게 답변하세요.
    답변 뒤에는 답을 도출하는 데 사용되는 문서의 팀 코드 목록을 문자 '|'로 구분해 안내합니다.
    출처가 없는 경우 '|' 을 사용하지 않습니다. 하나 이상의 출처가 있는 경우 맨 뒤에 한꺼번에 표시하세요.
    예시 답변 1: 1. B03 팀과 2. A11 팀이 있습니다. | B03 | A11
>>>>>>> aa1546075d267cd83b9018452aa4780eaef177d6
    예시 답변 2: C05 팀은.. | C05
